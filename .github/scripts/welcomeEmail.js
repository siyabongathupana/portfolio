...
// Custom sender name – change as you like
const SENDER_NAME = 'Siya From [Your Portfolio]';

const NOTIFIED_FILE = path.join(__dirname, '..', '..', 'data', 'notified_users.json');
const USERS_DIR = path.join(__dirname, '..', '..', 'data', 'users');

// Logo URL – replace with your actual logo image URL (can be in your repo)
const LOGO_URL = 'https://siyabongathupana.github.io/portfolio/logo.png'; // create a logo.png in your root or use a different URL
...
async function sendWelcomeEmail(toEmail, username) {
  ...
  const htmlContent = `
    ...
    <body style="margin:0; padding:20px; background:#eef3fc;">
      <div class="container">
        <div class="header">
          <img src="${LOGO_URL}" alt="${appName}" class="logo" style="max-width:80px;">
          <h1>${appName}</h1>
        </div>
        <div class="content">
        ...
        <div class="footer">
          ...
          <p>You are receiving this because you registered on our platform.</p>
